...
--
-- Host: localhost    Database: shopApp-2
-- ------------------------------------------------------
...
INSERT INTO `products` (`Id`, `Name`, `Price`, `ImageUrl`, `Category`, `DEscription`, `Stock`, `category_Id`) VALUES (7,'Samsung Note 6',1914,'3.jpg','Telefon','gg tel',5,NULL),(8,'Iphone 6',1980,'4.jpg','Telefon','xd tel',5,NULL),(9,'Samsung Note 6',2063,'5.jpg','Telefon','pp tel',5,NULL),(11,'gozluk',1232,'11.jpeg','Gozluk','gg gozluk',6,NULL);
...
-- Dump completed on 2020-11-12 15:43:46
-- MySQL dump 10.13  Distrib 8.0.22, for Linux (x86_64)
--
...
LOCK TABLES `products` WRITE;
/*!40000 ALTER TABLE `products` DISABLE KEYS */;
INSERT INTO `products` (`Id`, `Name`, `Price`, `ImageUrl`, `Category`, `DEscription`, `Stock`) VALUES (7,'Samsung Note 6',1914,'3.jpg','Telefon','gg tel',5),(8,'Iphone 6',1980,'4.jpg','Telefon','xd tel',5),(9,'Samsung Note 6',2063,'5.jpg','Telefon','pp tel',5),(11,'gozluk',1232,'11.jpeg','Gozluk','gg gozluk',6);
/*!40000 ALTER TABLE `products` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
CREATE TABLE `Movie_Detail` (
  ...
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Id_UNIQUE` (`Id`),
  CONSTRAINT `fk_Movie_Detail_Movie1` FOREIGN KEY (`Id`) REFERENCES `Movie` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Movie_has_Category` (
  ...
  KEY `fk_Movie_has_Category_Category1_idx` (`Category_Id`),
  KEY `fk_Movie_has_Category_Movie1_idx` (`Movie_Id`),
  CONSTRAINT `fk_Movie_has_Category_Category1` FOREIGN KEY (`Category_Id`) REFERENCES `Category` (`Id`),
  CONSTRAINT `fk_Movie_has_Category_Movie1` FOREIGN KEY (`Movie_Id`) REFERENCES `Movie` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `Movie_has_Category` WRITE;
/*!40000 ALTER TABLE `Movie_has_Category` DISABLE KEYS */;
/*!40000 ALTER TABLE `Movie_has_Category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Movie_has_Star`
--

DROP TABLE IF EXISTS `Movie_has_Star`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Movie_has_Star` (
  `Movie_Id` int NOT NULL,
  `Star_Id` int NOT NULL,
  PRIMARY KEY (`Movie_Id`,`Star_Id`),
  KEY `fk_Movie_has_Star_Star1_idx` (`Star_Id`),
  KEY `fk_Movie_has_Star_Movie1_idx` (`Movie_Id`),
  CONSTRAINT `fk_Movie_has_Star_Movie1` FOREIGN KEY (`Movie_Id`) REFERENCES `Movie` (`Id`),
  CONSTRAINT `fk_Movie_has_Star_Star1` FOREIGN KEY (`Star_Id`) REFERENCES `Star` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Movie_has_Star`
--

LOCK TABLES `Movie_has_Star` WRITE;
/*!40000 ALTER TABLE `Movie_has_Star` DISABLE KEYS */;
/*!40000 ALTER TABLE `Movie_has_Star` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-11-12 15:43:47
-- MySQL dump 10.13  Distrib 8.0.22, for Linux (x86_64)
--
...
INSERT INTO `customers2` (`id`, `name`, `age`, `salary`) VALUES (5,'B','33',5000),(6,'C','23',8500),(7,'D','27',6000),(8,'E','24',4500),(9,'A','25',2000);
...
INSERT INTO `employee_performance` (`employee_id`, `fullname`, `email`, `satis_adeti`) VALUES (1,'Nancy Freehafer','nancy@northwindtraders.com updated',12),(2,'Andrew Cencini','andrew@northwindtraders.com',4),(3,'Jan Kotas',' updated',6),(4,'Mariya Sergienko','mariya@northwindtraders.com  updated',8),(5,'Steven Thorpe','steven@northwindtraders.com',0),(6,'Michael Neipper','michael@northwindtraders.com',4),(7,'Robert Zare','robert@northwindtraders.com',2),(8,'Laura Giussani','laura@northwindtraders.com',2),(9,'Anne Hellung-Larsen','anne@northwindtraders.com',10);
...
INSERT INTO `inventory_transaction_types` (`id`, `type_name`) VALUES (1,'Purchased'),(2,'Sold'),(3,'On Hold'),(4,'Waste');
...
INSERT INTO `order_details_status` (`id`, `status_name`) VALUES (0,'None'),(1,'Allocated'),(2,'Invoiced'),(3,'Shipped'),(4,'On Order'),(5,'No Stock');
...
INSERT INTO `orders_status` (`id`, `status_name`) VALUES (0,'New'),(1,'Invoiced'),(2,'Shipped'),(3,'Closed');
...
INSERT INTO `orders_tax_status` (`id`, `tax_status_name`) VALUES (0,'Tax Exempt'),(1,'Taxable');
...
INSERT INTO `purchase_order_status` (`id`, `status`) VALUES (0,'New'),(1,'Submitted'),(2,'Approved'),(3,'Closed');
...
INSERT INTO `sales_reports` (`group_by`, `display`, `title`, `filter_row_source`, `default`) VALUES ('Category','Category','Sales By Category','SELECT DISTINCT [Category] FROM [products] ORDER BY [Category];',0),('country_region','Country/Region','Sales By Country','SELECT DISTINCT [country_region] FROM [customers Extended] ORDER BY [country_region];',0),('Customer ID','Customer','Sales By Customer','SELECT DISTINCT [Company] FROM [customers Extended] ORDER BY [Company];',0),('employee_id','Employee','Sales By Employee','SELECT DISTINCT [Employee Name] FROM [employees Extended] ORDER BY [Employee Name];',0),('Product ID','Product','Sales by Product','SELECT DISTINCT [Product Name] FROM [products] ORDER BY [Product Name];',1);
